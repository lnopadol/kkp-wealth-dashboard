/* ============================================
   KKP WEALTH PORTFOLIO DASHBOARD — Application
...
(function () {
  ...
  /* ------------------------------------------
     DATA — All 54 holdings
  ------------------------------------------ */
  var HOLDINGS = [
    { product: "VAYU1", details: "VAYU1", target: 2.20, assetClass: "Equity", sleeve: "Local Equity", thematic: null },
    { product: "SPDR Portfolio S&P 500 ETF", details: "SPLG.P", target: 10.20, assetClass: "Equity", sleeve: "Offshore Mandate", thematic: null },
    { product: "Vanguard S&P 500 ETF", details: "VOO.P", target: 5.43, assetClass: "Equity", sleeve: "Offshore Mandate", thematic: null },
    { product: "iShares MSCI USA Quality Factor ETF", details: "QUAL.BATS", target: 0.29, assetClass: "Equity", sleeve: "Offshore Mandate", thematic: null },
    { product: "Vanguard Russell 2000 ETF", details: "VTWO.O", target: 0.74, assetClass: "Equity", sleeve: "Offshore Mandate", thematic: null },
    { product: "iShares Europe Index (IE) Instl Dis USD", details: "IE00B4L8GV30", target: 3.70, assetClass: "Equity", sleeve: "Offshore Mandate", thematic: null },
    { product: "iShares Japan Index (IE) D Acc USD", details: "IE00BD0NCS18", target: 1.23, assetClass: "Equity", sleeve: "Offshore Mandate", thematic: null },
    { product: "iShares EmergMkts Idx (IE) D Acc USD", details: "IE00BYWYC907", target: 2.26, assetClass: "Equity", sleeve: "Offshore Mandate", thematic: null },
    { product: "iShares Dev RI Elt Idx (IE) D Acc $", details: "IE000LUZEWK5", target: 0.53, assetClass: "Equity", sleeve: "Offshore Mandate", thematic: null },
    { product: "iShares Global Infrastructure ETF", details: "IGF.O", target: 0.53, assetClass: "Equity", sleeve: "Offshore Mandate", thematic: null },
    { product: "iShares 20+ Year Treasury Bond ETF", details: "TLT.P", target: 2.47, assetClass: "Fixed Income", sleeve: "Offshore Mandate", thematic: null },
    { product: "State Street Glb Aggt Bd Idx I USD Hdg", details: "LU0956450620", target: 2.43, assetClass: "Fixed Income", sleeve: "Offshore Mandate", thematic: null },
    { product: "iShares Scrn Gl Corp Bd Idx Ins USD H A", details: "IE000JWH7DS4", target: 6.01, assetClass: "Fixed Income", sleeve: "Offshore Mandate", thematic: null },
    { product: "SSGA Stt Strt EM Hrd Ccy Govt Bd Idx I USD", details: "LU2407009567", target: 1.23, assetClass: "Fixed Income", sleeve: "Offshore Mandate", thematic: null },
    { product: "GSF II GS Tact Tilt Overlay IP USD Acc", details: "LU2322936241", target: 3.29, assetClass: "Alternative", sleeve: "Offshore Mandate", thematic: null },
    { product: "Cash in United States Dollar", details: "CASH.USD", target: 0.82, assetClass: "Cash", sleeve: "Offshore Mandate", thematic: null },
    { product: "Brown Advisory Global Leaders", details: "IE00BG0R3926", target: 0.82, assetClass: "Equity", sleeve: "Onshore Mandate", thematic: null },
    { product: "Dodge & Cox Worldwide", details: "IE00B54PRV58", target: 0.51, assetClass: "Equity", sleeve: "Onshore Mandate", thematic: null },
    { product: "Robeco Global Stars", details: "LU2080584019", target: 0.79, assetClass: "Equity", sleeve: "Onshore Mandate", thematic: null },
    { product: "BlackRock Advantage US", details: "IE00BFZP7V49", target: 0.85, assetClass: "Equity", sleeve: "Onshore Mandate", thematic: null },
    { product: "JPM US Select", details: "LU0248005711", target: 0.85, assetClass: "Equity", sleeve: "Onshore Mandate", thematic: null },
    { product: "Eleva European Selection", details: "LU1331971256", target: 0.41, assetClass: "Equity", sleeve: "Onshore Mandate", thematic: null },
    { product: "Invesco S&P 500 UCITS ETF", details: "IE00B3YCGJ38", target: 2.37, assetClass: "Equity", sleeve: "Onshore Mandate", thematic: null },
    { product: "iShares MSCI USA Quality", details: "US46432F3394", target: 0.22, assetClass: "Equity", sleeve: "Onshore Mandate", thematic: null },
    { product: "Amundi Index MSCI Europe", details: "LU1437015735", target: 0.57, assetClass: "Equity", sleeve: "Onshore Mandate", thematic: null },
    { product: "Nomura Japan Strategic", details: "IE00BW38TS53", target: 0.32, assetClass: "Equity", sleeve: "Onshore Mandate", thematic: null },
    { product: "Robeco Emerging Markets", details: "LU0478762148", target: 0.32, assetClass: "Equity", sleeve: "Onshore Mandate", thematic: null },
    { product: "RBC Emerging Markets", details: "LU2986377153", target: 0.32, assetClass: "Equity", sleeve: "Onshore Mandate", thematic: null },
    { product: "Kempen Global Small-Cap", details: "LU1894035184", target: 0.32, assetClass: "Equity", sleeve: "Onshore Mandate", thematic: null },
    { product: "DWS Invest Global Infrastructure", details: "LU2046587650", target: 0.32, assetClass: "Equity", sleeve: "Onshore Mandate", thematic: null },
    { product: "Principal Global Real Estate", details: "IE00B62LQD71", target: 0.32, assetClass: "Equity", sleeve: "Onshore Mandate", thematic: null },
    { product: "JPM Global Aggregate Bond", details: "LU0430493998", target: 3.36, assetClass: "Fixed Income", sleeve: "Onshore Mandate", thematic: null },
    { product: "PIMCO GIS Global Bond", details: "IE0002461055", target: 3.36, assetClass: "Fixed Income", sleeve: "Onshore Mandate", thematic: null },
    { product: "SSGA Global Agg Bond", details: "LU0956450620", target: 5.38, assetClass: "Fixed Income", sleeve: "Onshore Mandate", thematic: null },
    { product: "iShares USD Treasury 20+yr", details: "IE00BFM6TC58", target: 1.27, assetClass: "Fixed Income", sleeve: "Onshore Mandate", thematic: null },
    { product: "Amundi Global Corporate Bond", details: "LU3097925054", target: 2.63, assetClass: "Fixed Income", sleeve: "Onshore Mandate", thematic: null },
    { product: "PGIM Global Corporate Bond", details: "IE00BFLQZJ56", target: 2.63, assetClass: "Fixed Income", sleeve: "Onshore Mandate", thematic: null },
    { product: "Neuberger Berman EM Debt", details: "IE00B99K6R29", target: 0.63, assetClass: "Fixed Income", sleeve: "Onshore Mandate", thematic: null },
    { product: "GSF II GS Tact Tilt Overlay", details: "LU0721525060", target: 2.22, assetClass: "Alternative", sleeve: "Onshore Mandate", thematic: null },
    { product: "GS Alternative Trend", details: "LU1103308471", target: 0.63, assetClass: "Alternative", sleeve: "Onshore Mandate", thematic: null },
    { product: "Cash USD", details: "CASH.USD", target: 0.32, assetClass: "Cash", sleeve: "Onshore Mandate", thematic: null },
    { product: "KKP GINFRAEQ-H — Lazard Global Listed Infrastructure", details: "IE00B3X5FG30", target: 4.00, assetClass: "Alternative", sleeve: "Alternative", thematic: null },
    { product: "Onshore Fund of Hedge Funds", details: "Fund of HF", target: 5.00, assetClass: "Alternative", sleeve: "Alternative", thematic: null },
    { product: "KKP PEQ-UI — KKR Private Markets Equity Fund", details: "KKR K-PRIME", target: 6.00, assetClass: "Alternative", sleeve: "Alternative", thematic: null },
    { product: "ONE Medical Technology Fund — iShares Medical Devices ETF", details: "IHI", target: 1.00, assetClass: "Equity", sleeve: "Satellite", thematic: "MedTech" },
    { product: "K-GTECH — Columbia Threadneedle Global Technology", details: "LU0444971666", target: 1.00, assetClass: "Equity", sleeve: "Satellite", thematic: "Technology" },
    { product: "KKP SEMICON-H — iShares Semiconductor ETF", details: "SOXX", target: 1.00, assetClass: "Equity", sleeve: "Satellite", thematic: "Technology" },
    { product: "SCBRS2000(A) — iShares Russell 2000", details: "IWM", target: 1.00, assetClass: "Equity", sleeve: "Satellite", thematic: "Small Cap" },
    { product: "TISCOIN — iShares MSCI India ETF", details: "INDA", target: 1.00, assetClass: "Equity", sleeve: "Satellite", thematic: "India" },
    { product: "KKP INDIA-UH — Robeco Indian Equities I USD", details: "LU0944707735", target: 1.00, assetClass: "Equity", sleeve: "Satellite", thematic: "India" },
    { product: "KKP EUROPE-UH — GS Europe CORE Equity I EUR", details: "LU1856271447", target: 1.00, assetClass: "Equity", sleeve: "Satellite", thematic: "Europe" },
    { product: "KKP EUROPE-H — GS Europe CORE Equity I EUR", details: "LU0234682044", target: 1.00, assetClass: "Equity", sleeve: "Satellite", thematic: "Europe" },
    { product: "ES-EG-A Eastspring European Growth", details: "IE00B6TYHG95", target: 1.00, assetClass: "Equity", sleeve: "Satellite", thematic: "Europe" },
    { product: "B-EUPASSIVE — iShares STOXX Europe 600 ETF", details: "STOXX", target: 1.00, assetClass: "Equity", sleeve: "Satellite", thematic: "Europe" }
  ];

  var SLEEVE_ORDER = ["Local Equity", "Offshore Mandate", "Onshore Mandate", "Alternative", "Satellite"];
  var SLEEVE_COLORS = {
    "Local Equity": "#437a22",
    "Offshore Mandate": "#2d7ec7",
    "Onshore Mandate": "#20808D",
    "Alternative": "#7c5cbf",
    "Satellite": "#c49a2a"
  };

  var ASSET_CLASS_ORDER = ["Equity", "Fixed Income", "Alternative", "Cash"];
  var ASSET_CLASS_COLORS = { "Equity": "#2d7ec7", "Fixed Income": "#20808D", "Alternative": "#7c5cbf", "Cash": "#9b9a97" };
  ...
  var GEO_DATA = [
    { region: "US", pct: 40, contributors: "SPLG.P, VOO.P, QUAL, VTWO, TLT, BlackRock US, JPM US Select, Invesco S&P 500, IWM" },
    { region: "Europe", pct: 12, contributors: "iShares Europe, Eleva European, Amundi Europe, KKP EUROPE-UH/H, ES-EG-A, B-EUPASSIVE" },
    { region: "Emerging Markets", pct: 8, contributors: "iShares EM, Robeco EM, RBC EM, Neuberger EM Debt, SSGA EM Govt Bond" },
    { region: "Global/Multi", pct: 25, contributors: "Global bond funds, Global equity, GS Overlay, Hedge Funds" },
    { region: "Japan", pct: 3, contributors: "iShares Japan Index, Nomura Japan Strategic" },
    { region: "India", pct: 3, contributors: "TISCOIN/INDA, KKP INDIA-UH" },
    { region: "Thailand", pct: 3, contributors: "VAYU1, THB cash allocations" },
    { region: "Other", pct: 6, contributors: "Private equity (KKR), Global infrastructure, Dev RI, Global Real Estate" }
  ];

  var EQUITY_SUB = [
    { name: "US Large Cap (S&P 500)", pct: 20.6 },
    { name: "US Quality & Small Cap", pct: 3.3 },
    { name: "Europe", pct: 9.4 },
    { name: "Japan", pct: 1.6 },
    { name: "Emerging Markets", pct: 5.2 },
    { name: "India", pct: 2.0 },
    { name: "Global Active Equity", pct: 4.3 },
    { name: "Infrastructure / Real Estate", pct: 1.7 },
    { name: "Small Cap (Global)", pct: 1.3 },
    { name: "Technology & MedTech", pct: 3.0 }
  ];

  var FI_SUB = [
    { name: "US Treasury 20+yr", pct: 3.7 },
    { name: "Global Aggregate Bond", pct: 11.2 },
    { name: "Global Corporate Bond", pct: 11.3 },
    { name: "EM Government/Debt Bond", pct: 1.9 }
  ];

  var THEMES = {
    "MedTech": { icon: "\u{1F3E5}", pct: 1, thesis: "Medical technology is a secular growth sector driven by aging populations, rising healthcare spending globally, and innovation in devices like robotic surgery systems and cardiac monitors.", holdings: [] },
    "Technology": { icon: "\u{1F4BB}", pct: 2, thesis: "Technology remains the dominant growth sector. This allocation splits between a broad global tech fund and a focused semiconductor ETF.", holdings: [] },
    "Small Cap": { icon: "\u{1F3D7}\uFE0F", pct: 1, thesis: "US small-cap stocks (Russell 2000) have historically outperformed large caps over long periods.", holdings: [] },
    "India": { icon: "\u{1F1EE}\u{1F1F3}", pct: 2, thesis: "India is the world's fastest-growing major economy with favorable demographics, digital transformation, and infrastructure investment.", holdings: [] },
    "Europe": { icon: "\u{1F1EA}\u{1F1FA}", pct: 4, thesis: "Europe is trading at historically cheap valuations relative to the US. This 4% allocation reflects a tactical overweight.", holdings: [] }
  };
  ...
  var FUND_RESEARCH = {
    ...
    "IE00B3X5FG30": { url: "https://www.lazardassetmanagement.com/docs/9571/LazardGlobalListedInfrastructureEquityFundAAccUSDHedged_UCITSKIID_IE00B3X5FG30_en.pdf", ret10: null, expense: "0.92%" },
  ...
  var LEARN_EXPLANATIONS = {
    "Local Equity": {
      "VAYU1": "VAYU1 is a Thai equity fund providing direct exposure to the Thai stock market. It\u2019s the only local equity position, giving you Thai-baht returns with no currency risk."
    },
    "Offshore Mandate": {
      "SPLG.P": "The SPDR S&P 500 ETF tracks the 500 largest US companies at ultra-low cost. At 10.20%, it\u2019s the single largest position.",
      "VOO.P": "Vanguard S&P 500 complements SPLG for additional S&P 500 exposure. Together they give you ~15.6% in US large-cap equities.",
      ...
      "LU0956450620": "State Street Global Aggregate Bond Index is a broad global bond fund.",
    ...
    "Onshore Mandate": {
      ...
      "LU0956450620_ON": "SSGA Global Aggregate Bond (onshore) provides broad global bond market exposure \u2014 5.38%.",
    ...
    "Alternative": {
      "IE00B3X5FG30": "Lazard Global Listed Infrastructure invests in essential infrastructure assets \u2014 toll roads, pipelines, power grids.",
      "Fund of HF": "A diversified onshore fund of hedge funds providing exposure to multiple hedge fund strategies.",
      "KKR K-PRIME": "KKR Private Markets Equity Fund (K-PRIME) provides access to private equity \u2014 illiquid but potentially higher returns."
    },
    "Satellite": {
  ...
  var PROXY_RETURNS = {
    ...
    "US Quality":      [11.96, 21.83, -4.38, 31.49, 18.40, 28.71, -18.11, 26.29, 25.02, 12], // proxy S&P500
  ...
  function getHoldingProxy(h) {
    ...
    var p = h.product;
    // Local Equity
    if (h.sleeve === "Local Equity") return "Thai Equity";
    // Cash
    ...
    if (d === "LU0956450620" || d === "LU0430493998" || d === "IE0002461055") return "Global Bond";
    ...
    if (d === "Fund of HF") return "Hedge/Alt Trend";
    if (d === "KKR K-PRIME") return "Private Equity";
  ...
  function initThemeToggle() {
    var stored = safeStorage.getItem("kkp-theme");
    if (stored) {
    ...
    if (btn) {
      btn.addEventListener("click", function () {
        ...
        safeStorage.setItem("kkp-theme", next);
        applyChartDefaults();
        rebuildAllCharts();
      });
    }
  ...
  function renderKPIs() {
    ...
    var kpis = [
      ...
      { label: "Sleeves", value: "5", sub: "Portfolio segments", cls: "" },
      { label: "Asset Classes", value: "4", sub: "Equity, FI, Alt, Cash", cls: "" },
      { label: "Largest Sleeve", value: "41.15%", sub: "Offshore Mandate", cls: "accent" }
    ];
  ...
  function renderStructure() {
    ...
    SLEEVE_ORDER.forEach(function (sleeve, idx) {
      ...
      var mandateLabel = "";
      if (sleeve === "Offshore Mandate") mandateLabel = '<div style="padding:var(--space-2) var(--space-3);font-size:var(--text-xs);color:var(--text-muted);background:var(--surface-2);border-bottom:1px solid var(--border)">KKP Balanced Standard \u2014 15 underlying holdings</div>';
      if (sleeve === "Onshore Mandate") mandateLabel = '<div style="padding:var(--space-2) var(--space-3);font-size:var(--text-xs);color:var(--text-muted);background:var(--surface-2);border-bottom:1px solid var(--border)">KKP Moderate THB (Global Eq 25%) \u2014 25 underlying holdings</div>';
  ...
  function renderGeography() {
    ...
    var regions = [{ name: "North America", pct: 40 }, { name: "Europe", pct: 12 }, { name: "Asia-Pacific", pct: 6 }, { name: "Emerging Markets", pct: 8 }, { name: "Global/Multi-Region", pct: 25 }, { name: "Other", pct: 9 }];
  ...
  function renderLearnCards() {
    ...
    SLEEVE_ORDER.forEach(function (sleeve) {
      ...
      var iconClass = "local";
      if (sleeve === "Offshore Mandate") iconClass = "offshore";
      else if (sleeve === "Onshore Mandate") iconClass = "onshore";
      ...
      items.forEach(function (h) {
        ...
        if (!explain && sleeve === "Onshore Mandate" && h.details === "LU0956450620") explain = learnData["LU0956450620_ON"] || "";
        if (!explain && sleeve === "Onshore Mandate" && h.details === "CASH.USD") explain = learnData["CASH.USD_ON"] || "";
  ...
  function renderBacktest() {
    ...
    charts.backtestCum = new Chart(ctx1, {
      ...
      data: {
        labels: labels,
        datasets: [
          { label: "KKP Wealth Portfolio", data: portIndex.map(function (v) { return +v.toFixed(1); }), borderColor: "#20808D", backgroundColor: "rgba(32,128,141,0.08)", fill: true, tension: 0.3, borderWidth: 2.5, pointRadius: 3, pointBackgroundColor: "#20808D" },
    ...
    // Volatility chart (rolling 3-year since 10yr is short)
    var volData = [];
  ...
  /* ------------------------------------------
     TAB 8: PROJECTION (expanded compounding)
  ------------------------------------------ */
  var BASE_RATE = 0.065;
  var BOOST_RATE = 0.08;
  var STRESS_RATE = 0.04;
  ...
  function updateCompoundingDisplay() {
    ...
    kpis.innerHTML = [
      ...
      { label: "Stress (4.0%)", value: "\u0E3F" + fmt(stress20, 0) }
  ...
  /* Simple Monte Carlo percentile calculator */
  function monteCarloPercentiles(mu, sigma, years, startVal) {
    var nSims = 2000;
    var paths = [];
    // Seed: simple PRNG for reproducibility
    function gaussRand() {
      var u = 0, v = 0;
  ...
  function renderComparisonChart() {
    ...
    var inflRate = inflAdj ? 0.03 : 0;
    var strategies = [
      { name: "KKP Wealth (6.5%)", rate: 0.065 - inflRate, color: "#20808D" },
  ...
  function renderLostDecade() {
    ...
    // B. Scenario Analysis Table
    var scenarios = [
      { name: "Local Equity", stagflation: 3, stagnation: -3, dollar: 8 },
      { name: "Offshore Mandate — Equity", stagflation: -1, stagnation: -2, dollar: 3 },
      { name: "Offshore Mandate — Bonds", stagflation: 0, stagnation: 5, dollar: -2 },
      { name: "Onshore Mandate — Equity", stagflation: -1, stagnation: -2, dollar: 4 },
      { name: "Onshore Mandate — Bonds", stagflation: -1, stagnation: 5, dollar: -1 },
    ...
    // Add variation per year
    var stagVar = [1.5, -0.5, 0.2, 0.8, 0.3, 0.7, -0.2, 0.5, 1.0, 0.7];
    var stagnVar = [2.0, 0.5, 1.5, 0.8, 1.2, -0.5, 1.0, 0.5, 1.5, 1.5];
    var dollarVar = [4.0, 2.5, 3.5, 2.8, 3.0, 3.2, 2.5, 3.5, 2.8, 2.2];
    var baseVar = [8.0, 5.5, -2.0, 10.0, 6.0, 7.5, -4.0, 8.0, 6.5, 7.0];
    ...
    charts.ldStress = new Chart(ctx1, {
      ...
      data: {
        ...
        datasets: [
          ...
          { label: "Stagflation (~0.5%)", data: stagIdx.map(function (v) { return +v.toFixed(1); }), borderColor: "#A84B2F", borderWidth: 2, tension: 0.3, pointRadius: 2, borderDash: [5, 3] },
          { label: "Secular Stagnation (~1%)", data: stagnIdx.map(function (v) { return +v.toFixed(1); }), borderColor: "#c49a2a", borderWidth: 2, tension: 0.3, pointRadius: 2, borderDash: [5, 3] },
          { label: "Dollar Crisis (~3%)", data: dollarIdx.map(function (v) { return +v.toFixed(1); }), borderColor: "#7c5cbf", borderWidth: 2, tension: 0.3, pointRadius: 2, borderDash: [3, 3] }
        ]
      },
      options: { responsive: true, maintainAspectRatio: false, plugins: { legend: { position: "top" } }, scales: { x: { grid: { color: cc.grid } }, y: { grid: { color: cc.grid } } } }
    });
    ...
    var colorMap = { 3: "#A84B2F", 5: "#c49a2a", 6: "#c49a2a", 7: "#437a22" };
    ...
    // E. Recommendations
    var recos = [
      { icon: "warn", text: "<strong>Missing: Gold/commodity allocation</strong> — Critical in stagflation scenarios. Consider adding 5-10% gold/commodity ETF (e.g., GLD, PDBC)." },
      { icon: "warn", text: "<strong>Missing: Explicit tail-risk hedging</strong> — Trend-following is limited to the small GS Alternative Trend allocation. Consider dedicated tail-risk strategies." },
      ...
      { icon: "good", text: "<strong>Strength: Bond allocation</strong> — ~28% fixed income provides a deflation buffer and portfolio stability." },
      { icon: "idea", text: "<strong>Consider:</strong> Adding 5-10% gold/commodity allocation as an inflation hedge and dollar-crisis buffer." },
      { icon: "idea", text: "<strong>Consider:</strong> Increasing infrastructure weight from 4% to 6-8% for enhanced inflation protection." }
    ];
