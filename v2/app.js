/* ============================================
   KKP WEALTH V2 DASHBOARD — Application
   Growth-oriented portfolio with 50 holdings
   ============================================ */
...
(function () {
  ...
  /* ------------------------------------------
     DATA — All 50 holdings (flattened from nested JSON)
  ------------------------------------------ */
  var HOLDINGS = [
    /* Fixed Income sleeve */
    { product: "PIMCO GIS Global Bond", details: "PIMCO-GIS", target: 11.82, assetClass: "Fixed Income", sleeve: "Fixed Income", subSleeve: null, thematic: null },

    /* Equity sleeve */
    { product: "VAYU1", details: "VAYU1", target: 2.18, assetClass: "Equity", sleeve: "Equity", subSleeve: null, thematic: null },

    /* Mandate — Offshore (KKP Balanced Standard) */
    { product: "SPDR Portfolio S&P 500 ETF", details: "SPLG.P", target: 7.69, assetClass: "Equity", sleeve: "Mandate", subSleeve: "Offshore", thematic: null },
    { product: "Vanguard S&P 500 ETF", details: "VOO.P", target: 4.09, assetClass: "Equity", sleeve: "Mandate", subSleeve: "Offshore", thematic: null },
    { product: "iShares MSCI USA Quality Factor ETF", details: "QUAL.BATS", target: 0.22, assetClass: "Equity", sleeve: "Mandate", subSleeve: "Offshore", thematic: null },
    { product: "Vanguard Russell 2000 ETF", details: "VTWO.O", target: 0.56, assetClass: "Equity", sleeve: "Mandate", subSleeve: "Offshore", thematic: null },
    { product: "iShares Europe Index (IE) Instl Dis USD", details: "IE00B4L8GV30", target: 2.79, assetClass: "Equity", sleeve: "Mandate", subSleeve: "Offshore", thematic: null },
    { product: "iShares Japan Index (IE) D Acc USD", details: "IE00BD0NCS18", target: 0.93, assetClass: "Equity", sleeve: "Mandate", subSleeve: "Offshore", thematic: null },
    { product: "iShares EmergMkts Idx (IE) D Acc USD", details: "IE00BYWYC907", target: 1.70, assetClass: "Equity", sleeve: "Mandate", subSleeve: "Offshore", thematic: null },
    { product: "iShares Dev RI Elt Idx (IE) D Acc $", details: "IE000LUZEWK5", target: 0.40, assetClass: "Equity", sleeve: "Mandate", subSleeve: "Offshore", thematic: null },
    { product: "iShares Global Infrastructure ETF", details: "IGF.O", target: 0.40, assetClass: "Equity", sleeve: "Mandate", subSleeve: "Offshore", thematic: null },
    { product: "iShares 20+ Year Treasury Bond ETF", details: "TLT.P", target: 1.86, assetClass: "Fixed Income", sleeve: "Mandate", subSleeve: "Offshore", thematic: null },
    { product: "State Street Glb Aggt Bd Idx I USD Hdg", details: "LU0956450620", target: 1.83, assetClass: "Fixed Income", sleeve: "Mandate", subSleeve: "Offshore", thematic: null },
    { product: "iShares Scrn Gl Corp Bd Idx Ins USD H A", details: "IE000JWH7DS4", target: 4.53, assetClass: "Fixed Income", sleeve: "Mandate", subSleeve: "Offshore", thematic: null },
    { product: "SSGA Stt Strt EM Hrd Ccy Govt Bd Idx I USD", details: "LU2407009567", target: 0.93, assetClass: "Fixed Income", sleeve: "Mandate", subSleeve: "Offshore", thematic: null },
    { product: "GSF II GS Tact Tilt Overlay IP USD Acc", details: "LU2322936241", target: 2.48, assetClass: "Alternative", sleeve: "Mandate", subSleeve: "Offshore", thematic: null },
    { product: "Cash in United States Dollar", details: "CASH.USD", target: 0.62, assetClass: "Cash", sleeve: "Mandate", subSleeve: "Offshore", thematic: null },

    /* Mandate — Onshore (KKP Aggressive THB) */
    { product: "Brown Advisory Global Leaders", details: "IE00BG0R3926", target: 0.45, assetClass: "Equity", sleeve: "Mandate", subSleeve: "Onshore", thematic: null },
    { product: "Dodge & Cox Worldwide", details: "IE00B54PRV58", target: 0.27, assetClass: "Equity", sleeve: "Mandate", subSleeve: "Onshore", thematic: null },
    { product: "Robeco Global Stars", details: "LU2080584019", target: 0.45, assetClass: "Equity", sleeve: "Mandate", subSleeve: "Onshore", thematic: null },
    { product: "BlackRock Advantage US", details: "IE00BFZP7V49", target: 0.46, assetClass: "Equity", sleeve: "Mandate", subSleeve: "Onshore", thematic: null },
    { product: "JPM US Select", details: "LU0248005711", target: 0.46, assetClass: "Equity", sleeve: "Mandate", subSleeve: "Onshore", thematic: null },
    { product: "Eleva European Selection", details: "LU1331971256", target: 0.22, assetClass: "Equity", sleeve: "Mandate", subSleeve: "Onshore", thematic: null },
    { product: "Invesco S&P 500 UCITS ETF", details: "IE00B3YCGJ38", target: 0.91, assetClass: "Equity", sleeve: "Mandate", subSleeve: "Onshore", thematic: null },
    { product: "iShares MSCI USA Quality", details: "US46432F3394", target: 0.03, assetClass: "Equity", sleeve: "Mandate", subSleeve: "Onshore", thematic: null },
    { product: "Amundi Index MSCI Europe", details: "LU1437015735", target: 0.22, assetClass: "Equity", sleeve: "Mandate", subSleeve: "Onshore", thematic: null },
    { product: "Nomura Japan Strategic", details: "IE00BW38TS53", target: 0.14, assetClass: "Equity", sleeve: "Mandate", subSleeve: "Onshore", thematic: null },
    { product: "Robeco Emerging Markets", details: "LU0478762148", target: 0.17, assetClass: "Equity", sleeve: "Mandate", subSleeve: "Onshore", thematic: null },
    { product: "RBC Emerging Markets", details: "LU2986377153", target: 0.14, assetClass: "Equity", sleeve: "Mandate", subSleeve: "Onshore", thematic: null },
    { product: "Kempen Global Small-Cap", details: "LU1894035184", target: 0.14, assetClass: "Equity", sleeve: "Mandate", subSleeve: "Onshore", thematic: null },
    { product: "DWS Invest Global Infras", details: "LU2046587650", target: 0.07, assetClass: "Equity", sleeve: "Mandate", subSleeve: "Onshore", thematic: null },
    { product: "Principal Global Real Estate", details: "IE00B62LQD71", target: 0.07, assetClass: "Equity", sleeve: "Mandate", subSleeve: "Onshore", thematic: null },
    { product: "iShares USD Treasury 20+yr", details: "IE00BFM6TC58", target: 0.33, assetClass: "Fixed Income", sleeve: "Mandate", subSleeve: "Onshore", thematic: null },
    { product: "Neuberger Berman EM Debt", details: "IE00B99K6R29", target: 0.06, assetClass: "Fixed Income", sleeve: "Mandate", subSleeve: "Onshore", thematic: null },
    { product: "GSF II GS Tact Tilt Overlay", details: "LU0721525060", target: 0.30, assetClass: "Alternative", sleeve: "Mandate", subSleeve: "Onshore", thematic: null },
    { product: "GS Alternative Trend", details: "LU1103308471", target: 0.10, assetClass: "Alternative", sleeve: "Mandate", subSleeve: "Onshore", thematic: null },
    { product: "Cash USD", details: "CASH.USD_ON", target: 0.05, assetClass: "Cash", sleeve: "Mandate", subSleeve: "Onshore", thematic: null },

    /* Alternative sleeve */
    { product: "Lazard Global Listed Infrastructure Equity Fund", details: "IE00B3X5FG30", target: 8.00, assetClass: "Alternative", sleeve: "Alternative", subSleeve: "Lazard Infra", thematic: null },
    { product: "Onshore Fund of Hedge Funds", details: "FoHF", target: 6.00, assetClass: "Alternative", sleeve: "Alternative", subSleeve: "Hedge Fund", thematic: null },
    { product: "KKR Private Markets Equity Fund", details: "KKR-KPRIME", target: 6.00, assetClass: "Private Equity", sleeve: "Alternative", subSleeve: "KKR K-PRIME", thematic: null },

    /* Satellite — Thematic */
    { product: "iShares U.S. Medical Devices ETF", details: "IHI", target: 1.00, assetClass: "Equity", sleeve: "Satellite", subSleeve: "Thematic", thematic: "MedTech" },
    { product: "Columbia Threadneedle Global Technology", details: "LU0444971666", target: 1.00, assetClass: "Equity", sleeve: "Satellite", subSleeve: "Thematic", thematic: "Technology" },
    { product: "iShares Semiconductor ETF", details: "SOXX", target: 1.00, assetClass: "Equity", sleeve: "Satellite", subSleeve: "Thematic", thematic: "Technology" },
    { product: "iShares Russell 2000 ETF", details: "IWM", target: 1.00, assetClass: "Equity", sleeve: "Satellite", subSleeve: "Thematic", thematic: "Small Cap" },
    { product: "iShares MSCI India ETF", details: "INDA", target: 1.00, assetClass: "Equity", sleeve: "Satellite", subSleeve: "Thematic", thematic: "India" },
    { product: "Robeco Indian Equities I USD", details: "LU0944707735", target: 1.00, assetClass: "Equity", sleeve: "Satellite", subSleeve: "Thematic", thematic: "India" },
    { product: "Goldman Sachs Europe CORE Equity (Unhedged)", details: "LU1856271447", target: 1.00, assetClass: "Equity", sleeve: "Satellite", subSleeve: "Thematic", thematic: "Europe" },
    { product: "Goldman Sachs Europe CORE Equity (Hedged)", details: "LU0234682044", target: 1.00, assetClass: "Equity", sleeve: "Satellite", subSleeve: "Thematic", thematic: "Europe" },
    { product: "Wellington Strategic European Equity Fund", details: "IE00B6TYHG95", target: 1.00, assetClass: "Equity", sleeve: "Satellite", subSleeve: "Thematic", thematic: "Europe" },
    { product: "iShares STOXX Europe 600 UCITS ETF", details: "STOXX", target: 1.00, assetClass: "Equity", sleeve: "Satellite", subSleeve: "Thematic", thematic: "Europe" },

    /* Satellite — Passive Global */
    { product: "iShares MSCI ACWI ETF", details: "ACWI", target: 10.00, assetClass: "Equity", sleeve: "Satellite", subSleeve: "ACWI Passive", thematic: null },

    /* Satellite — Active Global */
    { product: "Capital Group New Perspective Fund", details: "CG-NP", target: 8.00, assetClass: "Equity", sleeve: "Satellite", subSleeve: "Capital Group Active", thematic: null },

    /* Satellite — Structured */
    { product: "DO Autocallable Notes", details: "DO-AUTO", target: 2.00, assetClass: "Structured", sleeve: "Satellite", subSleeve: "Structured Product", thematic: null }
  ];

  var SLEEVE_ORDER = ["Fixed Income", "Equity", "Mandate", "Alternative", "Satellite"];
  var SLEEVE_COLORS = {
    "Fixed Income": "#20808D",
    "Equity": "#437a22",
    "Mandate": "#2d7ec7",
  ...
  var ASSET_CLASS_ORDER = ["Equity", "Fixed Income", "Alternative", "Private Equity", "Cash", "Structured"];
  ...
  /* Geography data */
  var GEO_DATA = [
    { region: "US", pct: 40, contributors: "SPLG.P, VOO.P, QUAL, VTWO, TLT, BlackRock US, JPM US Select, Invesco S&P 500, IWM, ACWI (US portion), Capital Group" },
    { region: "Europe", pct: 15, contributors: "iShares Europe, Eleva European, Amundi Europe, GS Europe CORE (UH/H), Wellington European, STOXX 600, ACWI (Europe portion)" },
    { region: "Emerging Markets", pct: 8, contributors: "iShares EM, Robeco EM, RBC EM, Neuberger EM Debt, SSGA EM Govt Bond, India ETFs" },
    { region: "Japan", pct: 3, contributors: "iShares Japan Index, Nomura Japan Strategic, ACWI (Japan portion)" },
    { region: "Asia-Pacific", pct: 5, contributors: "ACWI (APAC portion), Regional mandates" },
    { region: "Thailand", pct: 3, contributors: "VAYU1 Thai Equity" },
    { region: "Global/Other", pct: 26, contributors: "PIMCO Global Bond (11.82%), Lazard Infra, KKR K-PRIME, Hedge Funds, DO Notes, Cash, GS Overlay" }
  ];

  /* Theme data for investment themes */
  var INV_THEMES = [
    { name: "S&P 500 / US Large Cap", pct: 14.4, icon: "\u{1F1FA}\u{1F1F8}", holdings: "SPLG.P (7.69%), VOO.P (4.09%), Invesco S&P 500 (0.91%), BlackRock US (0.46%), JPM US Select (0.46%), QUAL (0.25%)" },
    { name: "Global Equity", pct: 19.2, icon: "\u{1F30D}", holdings: "ACWI (10%), Capital Group NP (8%), Brown Advisory (0.45%), Dodge & Cox (0.27%), Robeco Global Stars (0.45%)" },
    { name: "European Equity", pct: 7.2, icon: "\u{1F1EA}\u{1F1FA}", holdings: "GS Europe UH (1%), GS Europe H (1%), Wellington European (1%), STOXX 600 (1%), iShares Europe (2.79%), Eleva (0.22%), Amundi Europe (0.22%)" },
    { name: "Indian Equity", pct: 2.0, icon: "\u{1F1EE}\u{1F1F3}", holdings: "INDA (1%), Robeco India (1%)" },
    { name: "Technology / Semiconductor", pct: 2.0, icon: "\u{1F4BB}", holdings: "Columbia Threadneedle Tech (1%), iShares Semiconductor (1%)" },
    { name: "Healthcare / MedTech", pct: 1.0, icon: "\u{1F3E5}", holdings: "iShares U.S. Medical Devices (1%)" },
    { name: "Small Cap", pct: 1.7, icon: "\u{1F3D7}\uFE0F", holdings: "iShares Russell 2000 (1%), Vanguard Russell 2000 (0.56%), Kempen Small-Cap (0.14%)" },
    { name: "Infrastructure", pct: 8.5, icon: "\u{1F3D7}\uFE0F", holdings: "Lazard Global Infrastructure (8%), iShares Global Infra ETF (0.40%), DWS Global Infra (0.07%)" },
    { name: "Private Equity", pct: 6.0, icon: "\u{1F4B0}", holdings: "KKR K-PRIME (6%)" },
    { name: "Active Bond Management", pct: 11.8, icon: "\u{1F4C8}", holdings: "PIMCO GIS Global Bond (11.82%)" }
  ];

  /* Satellite themes (thematic equity only) */
  var SAT_THEMES = {
    "MedTech": { icon: "\u{1F3E5}", pct: 1.0, thesis: "Medical technology is a secular growth sector driven by aging populations and innovation in robotic surgery, cardiac monitors, and diagnostic equipment.", holdings: [] },
    "Technology": { icon: "\u{1F4BB}", pct: 2.0, thesis: "Technology remains the dominant growth sector. This allocation splits between a broad global tech fund and a focused semiconductor ETF.", holdings: [] },
    "Small Cap": { icon: "\u{1F3D7}\uFE0F", pct: 1.0, thesis: "US small-cap stocks (Russell 2000) have historically outperformed large caps over long periods.", holdings: [] },
    "India": { icon: "\u{1F1EE}\u{1F1F3}", pct: 2.0, thesis: "India is the world's fastest-growing major economy with favorable demographics, digital transformation, and infrastructure investment.", holdings: [] },
    "Europe": { icon: "\u{1F1EA}\u{1F1FA}", pct: 4.0, thesis: "Europe is trading at historically cheap valuations relative to the US. This allocation reflects a tactical overweight across 4 funds.", holdings: [] }
  };
  ...
  var FUND_RESEARCH = {
    ...
    "CG-NP": { url: "https://www.capitalgroup.com/advisor/investments/fund/npfbx", ret10: "~12.5%", expense: "0.73%" }
  };

  /* LEARN explanations */
  var LEARN_EXPLANATIONS = {
    "Fixed Income": {
      "PIMCO-GIS": "PIMCO GIS Global Bond is one of the world\u2019s most respected active bond funds, managed by PIMCO. It has flexibility to invest across all global bond markets \u2014 government, corporate, EM, mortgage-backed \u2014 aiming to outperform passive bond indices through active duration and sector management."
    },
    "Equity": {
    ...
    "Mandate": {
      "SPLG.P": "The SPDR S&P 500 ETF tracks the 500 largest US companies at ultra-low cost. At 7.69%, it's the largest single equity holding in the mandate.",
      ...
      "IE000JWH7DS4": "iShares Global Corporate Bond Index invests in investment-grade corporate bonds globally. At 4.53%, it's the largest bond position in the mandate.",
    ...
    "Alternative": {
      "IE00B3X5FG30": "Lazard Global Listed Infrastructure invests in essential infrastructure assets \u2014 toll roads, pipelines, power grids. At 8%, it's V2's largest alternative holding and provides inflation-linked cash flows.",
      "FoHF": "A diversified onshore fund of hedge funds providing exposure to multiple hedge fund strategies for return diversification and lower correlation to equities.",
    ...
    "Satellite": {
      "IHI": "iShares US Medical Devices ETF invests in companies making surgical robots, cardiac devices, and diagnostic equipment. Doubled from 0.52% to 1.00% in V2.",
      "LU0444971666": "Columbia Threadneedle Global Technology provides broad exposure to leading tech companies worldwide.",
      "SOXX": "iShares Semiconductor ETF tracks chipmakers powering AI, EVs, smartphones. Doubled from 0.52% to 1.00%.",
      "IWM": "iShares Russell 2000 tracks US small-cap stocks with growth potential. Doubled to 1.00%.",
      "INDA": "iShares MSCI India ETF provides passive exposure to India\u2019s booming equity market. Doubled to 1.00%.",
      "LU0944707735": "Robeco Indian Equities provides active stock-picking in India. Doubled to 1.00%.",
      ...
      "ACWI": "iShares MSCI ACWI ETF provides exposure to ~2,900 stocks across 23 developed and 24 emerging markets. NEW in V2 at 10% \u2014 the single largest satellite position.",
      "CG-NP": "Capital Group New Perspective Fund is one of the world's most prestigious active equity funds with a 50+ year track record. NEW in V2 at 8% \u2014 provides growth-oriented global equity managed by Capital Group's multi-manager system.",
      "DO-AUTO": "DO Autocallable Notes are structured products that pay a coupon if a basket of underlying stocks stays above a barrier. Carries tail risk if stocks fall significantly below the barrier."
    }
  };
  ...
  function getHoldingProxy(h) {
    ...
    if (d === "CG-NP") return "Capital Group NP";
  ...
  function initTheme() {
    var stored = _store ? _store.getItem("kkpv2-theme") : null;
    if (stored) document.documentElement.setAttribute("data-theme", stored);
    document.getElementById("theme-toggle").addEventListener("click", function () {
      var current = document.documentElement.getAttribute("data-theme");
      var next = current === "dark" ? "light" : "dark";
      document.documentElement.setAttribute("data-theme", next);
      if (_store) _store.setItem("kkpv2-theme", next);
      applyChartDefaults();
  ...
  function renderOverview() {
    ...
    var kpis = [
      { label: "Total Holdings", value: "50", cls: "accent" },
      { label: "Sleeves", value: "5", cls: "" },
      { label: "Asset Classes", value: "6", cls: "" },
      { label: "Largest Sleeve", value: largestSleeve + " " + fmtPct(sleeveTotals[largestSleeve]), cls: "accent", sub: "36% of portfolio" }
    ];
  ...
  function renderStructure() {
    ...
    var structure = [
      {
        name: "Fixed Income", color: SLEEVE_COLORS["Fixed Income"], pct: 11.82,
        groups: [{ label: null, holdings: HOLDINGS.filter(function (h) { return h.sleeve === "Fixed Income"; }) }]
      },
      {
        name: "Equity", color: SLEEVE_COLORS["Equity"], pct: 2.18,
        groups: [{ label: null, holdings: HOLDINGS.filter(function (h) { return h.sleeve === "Equity"; }) }]
      },
      {
        name: "Mandate", color: SLEEVE_COLORS["Mandate"], pct: 36.00,
        groups: [
          { label: "Offshore \u2014 KKP Balanced Standard (31.00%)", holdings: HOLDINGS.filter(function (h) { return h.sleeve === "Mandate" && h.subSleeve === "Offshore"; }) },
          { label: "Onshore \u2014 KKP Aggressive THB (5.00%)", holdings: HOLDINGS.filter(function (h) { return h.sleeve === "Mandate" && h.subSleeve === "Onshore"; }) }
        ]
      },
      {
        name: "Alternative", color: SLEEVE_COLORS["Alternative"], pct: 20.00,
        groups: [
          { label: "Lazard Infrastructure (8.00%)", holdings: HOLDINGS.filter(function (h) { return h.sleeve === "Alternative" && h.subSleeve === "Lazard Infra"; }) },
          { label: "Fund of Hedge Funds (6.00%)", holdings: HOLDINGS.filter(function (h) { return h.sleeve === "Alternative" && h.subSleeve === "Hedge Fund"; }) },
          { label: "KKR K-PRIME Private Equity (6.00%)", holdings: HOLDINGS.filter(function (h) { return h.sleeve === "Alternative" && h.subSleeve === "KKR K-PRIME"; }) }
        ]
      },
      {
        name: "Satellite", color: SLEEVE_COLORS["Satellite"], pct: 30.00,
        groups: [
          { label: "Thematic Equity (10.00%)", holdings: HOLDINGS.filter(function (h) { return h.sleeve === "Satellite" && h.subSleeve === "Thematic"; }) },
          { label: "ACWI Passive (10.00%)", holdings: HOLDINGS.filter(function (h) { return h.sleeve === "Satellite" && h.subSleeve === "ACWI Passive"; }) },
          { label: "Capital Group Active (8.00%)", holdings: HOLDINGS.filter(function (h) { return h.sleeve === "Satellite" && h.subSleeve === "Capital Group Active"; }) },
          { label: "DO Autocallable Notes (2.00%)", holdings: HOLDINGS.filter(function (h) { return h.sleeve === "Satellite" && h.subSleeve === "Structured Product"; }) }
        ]
      }
    ];
  ...
  function renderBacktest() {
    ...
    charts.backtestCumul = new Chart(document.getElementById("chart-backtest-cumulative"), {
      ...
      data: {
        labels: labels,
        datasets: [
          { label: "V2 Portfolio", data: portIndex.map(function (v) { return +v.toFixed(1); }), borderColor: "#20808D", borderWidth: 2.5, fill: false, tension: 0.3, pointRadius: 3 },
  ...
  function renderProjection() {
    ...
    var VOL = 12;
    var YEARS_PROJ = 20;
    var CONSERVATIVE_RATE = 5;
    var OPTIMISTIC_RATE = 12;
  ...
  function renderCashFlow() {
    ...
    function runCashFlow() {
      ...
      var returnRate = parseFloat(document.getElementById("cf-return-input").value) || 8.5;
  ...
  function renderCriticalAnalysis() {
    /* A. Asset Allocation Shift table */
    var shiftData = [
      { asset: "Equity", expanded: 24.13, v2: 42.85 },
      { asset: "Fixed Income", expanded: 16.82, v2: 21.36 },
      { asset: "Alternative", expanded: 7.39, v2: 8.88 },
      { asset: "Private Equity", expanded: 6.31, v2: 6.00 },
      { asset: "Commodities (Gold)", expanded: 14.43, v2: 0.00 },
      { asset: "Infrastructure", expanded: 2.50, v2: 8.00 },
      { asset: "Cash", expanded: 27.78, v2: 0.67 },
      { asset: "Structured Products", expanded: 0.00, v2: 2.00 }
    ];
    var tbody = document.getElementById("ca-shift-tbody");
    tbody.innerHTML = shiftData.map(function (r) {
      var change = r.v2 - r.expanded;
      var cls = change > 0.1 ? "positive" : (change < -0.1 ? "negative" : "");
      var sign = change > 0 ? "+" : "";
      return '<tr><td>' + r.asset + '</td><td class="num">' + r.expanded.toFixed(2) + '%</td><td class="num">' + r.v2.toFixed(2) + '%</td><td class="num ' + cls + '">' + sign + change.toFixed(2) + '%</td></tr>';
    }).join("");
    ...
    charts.caRadar = new Chart(document.getElementById("chart-ca-radar"), {
      ...
      data: {
        ...
        datasets: [
          ...
          { label: "V2", data: v2Scores, borderColor: "#20808D", backgroundColor: "rgba(32,128,141,0.15)", borderWidth: 2.5, pointRadius: 4, pointBackgroundColor: "#20808D" }
        ]
      },
      options: {
        responsive: true, maintainAspectRatio: false,
    ...
    /* C. Scenario Analysis */
    var scenarios = [
      { title: "\u{1F4C8} Bull Market", expanded: "+4.1%", v2: "+8.2%", delta: "V2 wins by +4.1%", deltaClass: "positive" },
      { title: "\u26A0\uFE0F Pape War Scenario", expanded: "-1.9%", v2: "-10.7%", delta: "V2 loses by -8.8%", deltaClass: "negative" },
      { title: "\u{1F4C9} Recession", expanded: "-3.0%", v2: "-12.0%", delta: "V2 loses by -9.0%", deltaClass: "negative" }
    ];
    ...
    scenContainer.innerHTML = scenarios.map(function (s) {
      return '<div class="ca-scenario-card">' +
        ...
        '<div class="ca-scenario-row"><span>V2</span><span>' + s.v2 + '</span></div>' +
    ...
    /* D. Top 10 Concerns */
    var concerns = [
      { text: "Zero gold allocation \u2014 no inflation hedge or crisis buffer", severity: "RED" },
      { text: "Zero cash buffer \u2014 no liquidity for opportunistic rebalancing", severity: "RED" },
      { text: "22% illiquid assets (PE 6% + Infra 8% + Hedge Fund 6% + DO Notes 2%)", severity: "RED" },
      { text: "DO Autocallable tail risk \u2014 significant downside if underlying stocks breach barrier", severity: "YELLOW" },
      { text: "PIMCO concentration \u2014 11.82% in a single bond fund", severity: "YELLOW" },
      { text: "Infrastructure 8% aggressive \u2014 sector concentration risk", severity: "YELLOW" },
      { text: "43% equity exposure \u2014 large drawdown risk in bear markets", severity: "YELLOW" },
      { text: "Aggressive THB mandate \u2014 higher risk onshore allocation", severity: "YELLOW" },
      { text: "Doubled satellite themes \u2014 10% in concentrated thematic bets", severity: "YELLOW" },
      { text: "No THB hedge buffer \u2014 currency risk on USD-denominated holdings", severity: "YELLOW" }
    ];
    ...
    /* E. What V2 Does Well */
    var strengths = [
      "Higher expected return (~8\u201310% vs 5\u20136%) for investors with a long time horizon",
      "Better equity diversification through ACWI (2,900 stocks) + Capital Group (50+ year track record)",
      "PIMCO active bond management \u2014 flexibility to navigate any bond market environment",
      "Capital Group New Perspective Fund \u2014 one of the world's most prestigious active managers with 50+ year track record",
      "Larger PE allocation captures illiquidity premium through KKR's institutional deal flow"
    ];
